//
//  CustomCell_Canvas_CollectionView.swift
//  Editor
//
...
class CustomCell_Canvas_CollectionView: UICollectionViewCell {
    ...
    let title: UILabel = {
        ...
        t.numberOfLines = 0
        t.font = UIFont(name: font_Light, size: CGFloat(font_Size_Ratio_Title))
